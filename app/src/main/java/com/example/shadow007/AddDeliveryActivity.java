                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                UserProfileChangeRequest profileUpdates = new UserProfileChangeRequest.Builder()
                                        .setDisplayName("delivery " + name+" "+surname+" "+phone)
                                        .build();
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(AddDeliveryActivity.this,"You successfully registered new delivery member.",Toast.LENGTH_LONG).show();
                                                }
                                            }
                                        });
                                Float rating=(float)0.0;
                                User user1=new User(user.getUid(),name,surname,phone,email,"delivery");
